...
public class CreateConserveTask extends AbstractTask {
	...
	public CreateConserveTask(CySwingAppAdapter appAdapter, List<CyNetwork> networks, boolean directed,
			int k, float r) {
...
//		int [] C= {0,0,0,1,1,1,2,2,2,2};
		...
		List<CyNode> nodeList=new ArrayList<>(n);
